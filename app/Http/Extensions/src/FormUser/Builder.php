...
namespace App\Http\Extensions\src\FormUser;
...
class Builder
{
     ...
     * @param Form $form
     */
    public function __construct(FormUser $form)
    {
        $this->form = $form;
    ...
    protected function addRedirectUrlField()
    {
        ...
        if (Str::contains($previous, url($this->getResource()))) {
            $this->addHiddenField((new FormUser\Field\Hidden(static::PREVIOUS_URL_KEY))->value($previous));
        }
    }
    ...
    public function open($options = [])
    {
        ...
        if ($this->mode == self::MODE_EDIT) {
            $this->addHiddenField((new FormUser\Field\Hidden('_method'))->value('PUT'));
        }
