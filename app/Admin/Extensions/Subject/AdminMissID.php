 ...
 * @method static \App\Admin\Extensions\Subject\FormID form($model, \Closure $callable)
 ...
 */
class AdminMissID extends Facade
{
    protected static function getFacadeAccessor()
    {
        return \App\Admin\Extensions\Subject\AdminID::class;
    }
}
