        ...
        <div class="col-md-12">
            <div class="box box-info">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="<?php echo e($router_target); ?>"
                    ...
                    <a href="<?php echo e(asset('storage/Danh sách SV.xlsx')); ?>" download src="file" target="_blank">
                        Tải mẫu danh sách
                    </a>
                </div>
            </div>
