                ...
                <div class="tab-content fields-group">
                    <div class="tab-pane active" id="tab-form-1" >
                            <div class="gridResultAll">
                                @include('admin.Teacher.ResultRegisterStudent.table_result')
                            </div>
                            <div class="gridTimeTable">
                                @include('admin.Teacher.ResultRegisterStudent.info_view_subject')
                            </div>
                                @include('admin.Teacher.ResultRegisterStudent.info_grid_timetable')
                    </div>
                </div>
            </div>
            <!-- /.box-body -->
